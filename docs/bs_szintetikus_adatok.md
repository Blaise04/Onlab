...
|---|---|---|-----------------------------------------------|---|
| Részvényár | S | Az alaptermék jelenlegi piaci ára | $10 – $150 (vagy S/K ∈ [0.5, 1.5])            | Uniform vagy log-normális (GBM) |
...
**Moneyness (S/K arány):**
- Reális tartomány: m ∈ [0.5, 1.5] — kizárja a mélyen out-of-the-money (OTM) és in-the-money (ITM) eseteket
